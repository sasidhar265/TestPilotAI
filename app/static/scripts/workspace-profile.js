...
const toggle = $('profile-toggle'), panel = $('profile-panel');
function closeProfile() { panel.classList.add('hidden'); toggle.setAttribute('aria-expanded', 'false'); }
...
document.addEventListener('keydown', event => {
  if (event.key === 'Escape' && !panel.classList.contains('hidden')) { closeProfile(); toggle.focus(); }
});
