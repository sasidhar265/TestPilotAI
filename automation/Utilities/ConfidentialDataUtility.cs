...
public static class ConfidentialDataUtility
{
    ...
    {
        var secrets = new[] { "OPENAI_API_KEY", "GEMINI_API_KEY", "COPILOT_GITHUB_TOKEN", "API_AUTH_TOKEN" }
            .Select(name => new { Name = name, Value = Environment.GetEnvironmentVariable(name) })
